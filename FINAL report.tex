...
\setcounter{page}{1}		
	...
	Rolland\index[authors]{Rolland, E.} et al. \cite{ROLL97} explored the efficiency of tabu search\index[terms]{tabu search}\index[terms]{metaheuristic!tabu search} using randomly generated datasets as test problems, and this was compared to results obtained from a two-exchange heuristic\index[terms]{heuristic} and an integer programming algorithm.  A heuristic\index[terms]{heuristic} concentration was compared to tabu search by Rosing\index[authors]{Rosing, K. E.} et al. \cite{ROSI98}.  Since datasets were independently and randomly generated for each of these studies, it makes it very difficult to compare results.
...
\np	
	...
	\subsubsection{Results}\index[terms]{greedy algorithm}\index[terms]{greedy algorithm!results}\index[terms]{constructive heuristic!greedy algorithm}
	...
	\begin{table}[]\index[terms]{greedy algorithm}\index[terms]{greedy algorithm!results}\index[terms]{constructive heuristic!greedy algorithm}
		\centering
...
\np
	...
	\index[terms]{fast greedy algorithm}\index[terms]{fast greedy algorithm!results}\index[terms]{constructive heuristic!fast greedy algorithm}
	...
	\begin{table}[]\index[terms]{fast greedy algorithm}\index[terms]{fast greedy algorithm!results}\index[terms]{constructive heuristic!fast greedy algorithm}
		\centering
	...
	\subsubsection{Results}\index[terms]{stingy algorithm}\index[terms]{stingy algorithm!results}\index[terms]{constructive heuristic!stingy algorithm}
	...
	The time required by the stingy algorithm to find a feasible solution increased dramatically as the network size of the problem increased.  This can be seen in figure \ref{percentmedvstime_stingy}.  The expected decrease in computational time as the number of medians increases is visible, particularly in the test problem with 400 nodes, but does not offer much of a saving to justify the use of this algorithm to solve the $p$-median problem.	
		...
		\begin{table}[]\index[terms]{stingy algorithm}\index[terms]{stingy algorithm!results}\index[terms]{constructive heuristic!stingy algorithm}
			\centering
...
\np	
	...
	\subsubsection{Results}\index[terms]{heuristic!interchange algorithm of Teitz and Bart}\index[terms]{interchange algorithm of Teitz and Bart}\index[terms]{interchange algorithm of Teitz and Bart!results}
	...
	\begin{table}[]\index[terms]{heuristic!interchange algorithm of Teitz and Bart}\index[terms]{interchange algorithm of Teitz and Bart}\index[terms]{interchange algorithm of Teitz and Bart!results}
		\centering
		\caption{Results of the Interchange Algorithm of Teitz and Bart - Greedy (50 Runs)}
		\label{teitzandbart.greedy.simple}
		\resizebox{\textwidth}{!}{%
			\begin{tabular}{cccccccc}
				\textbf{\begin{tabular}[c]{@{}c@{}}Test\\ Problem\end{tabular}} & \textbf{p} & \textbf{n} & \textbf{Edges} & \textbf{\begin{tabular}[c]{@{}c@{}}Optimal\\ Value\end{tabular}} & \textbf{\begin{tabular}[c]{@{}c@{}}Computational\\ Time (seconds)\end{tabular}} & \textbf{\begin{tabular}[c]{@{}c@{}}Gap to Optimal\\ (percent)\end{tabular}} & \textbf{\begin{tabular}[c]{@{}c@{}}Num. of\\ Iterations\end{tabular}} \\
				\rowcolor[HTML]{EFEFEF} 
				1 & 5 & 100 & 198 & 5819 & 0.1 $\pm$ 0.02 & 0 $\pm$ 0 & 6 $\pm$ 0 \\
				\rowcolor[HTML]{EFEFEF} 
				2 & 10 & 100 & 193 & 4093 & 0.1 $\pm$ 0.01 & 0.3 $\pm$ 0 & 10 $\pm$ 0 \\
				\rowcolor[HTML]{EFEFEF} 
				3 & 10 & 100 & 198 & 4250 & 0.1 $\pm$ 0.02 & 0 $\pm$ 0 & 3 $\pm$ 0 \\
				\rowcolor[HTML]{EFEFEF} 
				4 & 20 & 100 & 196 & 3034 & 0.1 $\pm$ 0.02 & 0.4 $\pm$ 0 & 4 $\pm$ 0 \\
				\rowcolor[HTML]{EFEFEF} 
				5 & 33 & 100 & 196 & 1355 & 0.1 $\pm$ 0.02 & 0.4 $\pm$ 0 & 10 $\pm$ 0 \\
				6 & 5 & 200 & 786 & 7824 & 0.1 $\pm$ 0.02 & 0 $\pm$ 0 & 16 $\pm$ 0 \\
				7 & 10 & 200 & 779 & 5631 & 0.2 $\pm$ 0.02 & 0.2 $\pm$ 0 & 12 $\pm$ 0 \\
				8 & 20 & 200 & 792 & 4445 & 0.3 $\pm$ 0.02 & 0.3 $\pm$ 0 & 6 $\pm$ 0 \\
				9 & 40 & 200 & 785 & 2734 & 0.7 $\pm$ 0.04 & 0.7 $\pm$ 0 & 3 $\pm$ 0 \\
	...
	\begin{table}[]\index[terms]{heuristic!interchange algorithm of Teitz and Bart}\index[terms]{interchange algorithm of Teitz and Bart}\index[terms]{interchange algorithm of Teitz and Bart!results}
		\centering
		\caption{Results of the Interchange Algorithm of Teitz and Bart - Random (50 Runs)}
		\label{teitzandbart.random.simple}
		\resizebox{\textwidth}{!}{%
			\begin{tabular}{cccccccc}
				\textbf{\begin{tabular}[c]{@{}c@{}}Test\\ Problem\end{tabular}} & \textbf{p} & \textbf{n} & \textbf{Edges} & \textbf{\begin{tabular}[c]{@{}c@{}}Optimal\\ Value\end{tabular}} & \textbf{\begin{tabular}[c]{@{}c@{}}Computational\\ Time (seconds)\end{tabular}} & \textbf{\begin{tabular}[c]{@{}c@{}}Gap to Optimal\\ (percent)\end{tabular}} & \textbf{\begin{tabular}[c]{@{}c@{}}Num. of\\ Iterations\end{tabular}} \\
				\rowcolor[HTML]{EFEFEF} 
				1 & 5 & 100 & 198 & 5819 & 0.1 $\pm$ 0.01 & 0 $\pm$ 0 & 17 $\pm$ 0 \\
				\rowcolor[HTML]{EFEFEF} 
				2 & 10 & 100 & 193 & 4093 & 0.1 $\pm$ 0.02 & 0 $\pm$ 0 & 65.5 $\pm$ 0.53 \\
				\rowcolor[HTML]{EFEFEF} 
				3 & 10 & 100 & 198 & 4250 & 0.2 $\pm$ 0.01 & 0 $\pm$ 0 & 21 $\pm$ 0 \\
				\rowcolor[HTML]{EFEFEF} 
				4 & 20 & 100 & 196 & 3034 & 0.2 $\pm$ 0.02 & 0.4 $\pm$ 0 & 33 $\pm$ 0 \\
				\rowcolor[HTML]{EFEFEF} 
				5 & 33 & 100 & 196 & 1355 & 0.3 $\pm$ 0.02 & 1.3 $\pm$ 0 & 63.6 $\pm$ 0.52 \\
				6 & 5 & 200 & 786 & 7824 & 0.2 $\pm$ 0.03 & 0 $\pm$ 0 & 101.8 $\pm$ 1.23 \\
				7 & 10 & 200 & 779 & 5631 & 0.2 $\pm$ 0.02 & 0 $\pm$ 0 & 111.5 $\pm$ 3.14 \\
				8 & 20 & 200 & 792 & 4445 & 0.6 $\pm$ 0.03 & 0.2 $\pm$ 0 & 20 $\pm$ 0 \\
	...
	\subsubsection{Results}\index[terms]{heuristic!fast interchange}\index[terms]{fast interchange}\index[terms]{local search}\index[terms]{fast interchange!results}
	...
	\begin{table}[]\index[terms]{heuristic!fast interchange}\index[terms]{fast interchange}\index[terms]{local search}\index[terms]{fast interchange!results}
		\centering
		\caption{Results of the Fast Interchange Algorithm - Greedy (50 Runs)}
		\label{fastint.greedy.simple}
		\resizebox{\textwidth}{!}{%
			\begin{tabular}{cccccccc}
				\textbf{\begin{tabular}[c]{@{}c@{}}Test\\ Problem\end{tabular}} & \textbf{p} & \textbf{n} & \textbf{Edges} & \textbf{\begin{tabular}[c]{@{}c@{}}Optimal\\ Value\end{tabular}} & \textbf{\begin{tabular}[c]{@{}c@{}}Computational\\ Time (seconds)\end{tabular}} & \textbf{\begin{tabular}[c]{@{}c@{}}Gap to Optimal\\ (percent)\end{tabular}} & \textbf{\begin{tabular}[c]{@{}c@{}}Num. of\\ Iterations\end{tabular}} \\
				\rowcolor[HTML]{EFEFEF} 
	...
	\begin{table}[]\index[terms]{heuristic!fast interchange}\index[terms]{fast interchange}\index[terms]{local search}\index[terms]{fast interchange!results}
	\centering
	\caption{Results of the Fast Interchange Algorithm - Random (50 Runs)}
	\label{fastint.rand.simple}
	\resizebox{\textwidth}{!}{%
		\begin{tabular}{cccccccc}
			\textbf{\begin{tabular}[c]{@{}c@{}}Test\\ Problem\end{tabular}} & \textbf{p} & \textbf{n} & \textbf{Edges} & \textbf{\begin{tabular}[c]{@{}c@{}}Optimal\\ Value\end{tabular}} & \textbf{\begin{tabular}[c]{@{}c@{}}Computational\\ Time (seconds)\end{tabular}} & \textbf{\begin{tabular}[c]{@{}c@{}}Gap to Optimal\\ (percent)\end{tabular}} & \textbf{\begin{tabular}[c]{@{}c@{}}Num. of\\ Iterations\end{tabular}} \\
				\rowcolor[HTML]{EFEFEF} 
				1 & 5 & 100 & 198 & 5819 & 0.2 $\pm$ 0.02 & 0 $\pm$ 0 & 16 $\pm$ 0 \\
				\rowcolor[HTML]{EFEFEF} 
				2 & 10 & 100 & 193 & 4093 & 0.2 $\pm$ 0.02 & 0.2 $\pm$ 0 & 30 $\pm$ 0 \\
				\rowcolor[HTML]{EFEFEF} 
				3 & 10 & 100 & 198 & 4250 & 0.2 $\pm$ 0.02 & 2.7 $\pm$ 0.38 & 26 $\pm$ 1 \\
				\rowcolor[HTML]{EFEFEF} 
				4 & 20 & 100 & 196 & 3034 & 0.3 $\pm$ 0.02 & 1.2 $\pm$ 0 & 31 $\pm$ 0 \\
				\rowcolor[HTML]{EFEFEF} 
				5 & 33 & 100 & 196 & 1355 & 0.4 $\pm$ 0.02 & 3.1 $\pm$ 0 & 37 $\pm$ 0 \\
				6 & 5 & 200 & 786 & 7824 & 0.3 $\pm$ 0.02 & 0 $\pm$ 0 & 24 $\pm$ 0 \\
				7 & 10 & 200 & 779 & 5631 & 0.5 $\pm$ 0.03 & 0 $\pm$ 0 & 32 $\pm$ 0 \\
				8 & 20 & 200 & 792 & 4445 & 0.7 $\pm$ 0.03 & 0.4 $\pm$ 0 & 47 $\pm$ 0 \\
				9 & 40 & 200 & 785 & 2734 & 1.1 $\pm$ 0.06 & 1.3 $\pm$ 0.02 & 55 $\pm$ 0.5 \\
	...
	\subsubsection{Results}\index[terms]{heuristic!alternate algorithm}\index[terms]{alternate algorithm}\index[terms]{local search}\index[terms]{alternate algorithm!results}
...
\begin{table}[]\index[terms]{heuristic!alternate algorithm}\index[terms]{alternate algorithm}\index[terms]{local search}\index[terms]{alternate algorithm!results}
	\centering
	\caption{Results of the Alternate Algorithm - Greedy (50 Runs)}
	\label{alt.greedy.simple}
	\resizebox{\textwidth}{!}{%
		\begin{tabular}{cccccccc}
			\textbf{\begin{tabular}[c]{@{}c@{}}Test\\ Problem\end{tabular}} & \textbf{p} & \textbf{n} & \textbf{Edges} & \textbf{\begin{tabular}[c]{@{}c@{}}Optimal\\ Value\end{tabular}} & \textbf{\begin{tabular}[c]{@{}c@{}}Computational\\ Time (seconds)\end{tabular}} & \textbf{\begin{tabular}[c]{@{}c@{}}Gap to Optimal\\ (percent)\end{tabular}} & \textbf{\begin{tabular}[c]{@{}c@{}}Num. of\\ Iterations\end{tabular}} \\
				\rowcolor[HTML]{EFEFEF} 
	...
	\begin{table}[]\index[terms]{heuristic!alternate algorithm}\index[terms]{alternate algorithm}\index[terms]{local search}\index[terms]{alternate algorithm!results}
		\centering
		\caption{Results of the Alternate Algorithm - Random (50 Runs)}
		\label{alt.random.simple}
		\resizebox{\textwidth}{!}{%
			\begin{tabular}{cccccccc}
				\textbf{\begin{tabular}[c]{@{}c@{}}Test\\ Problem\end{tabular}} & \textbf{p} & \textbf{n} & \textbf{Edges} & \textbf{\begin{tabular}[c]{@{}c@{}}Optimal\\ Value\end{tabular}} & \textbf{\begin{tabular}[c]{@{}c@{}}Computational\\ Time (seconds)\end{tabular}} & \textbf{\begin{tabular}[c]{@{}c@{}}Gap to Optimal\\ (percent)\end{tabular}} & \textbf{\begin{tabular}[c]{@{}c@{}}Num. of\\ Iterations\end{tabular}} \\
				\rowcolor[HTML]{EFEFEF} 
				1 & 5 & 100 & 198 & 5819 & 0.1 $\pm$ 0.03 & 2.9 $\pm$ 0 & 4.3 $\pm$ 0.44 \\
				\rowcolor[HTML]{EFEFEF} 
				2 & 10 & 100 & 193 & 4093 & 0.3 $\pm$ 0.09 & 22.8 $\pm$ 1.78 & 5.2 $\pm$ 1.2 \\
				\rowcolor[HTML]{EFEFEF} 
				3 & 10 & 100 & 198 & 4250 & 0.3 $\pm$ 0.1 & 13.5 $\pm$ 3.08 & 5.8 $\pm$ 1.49 \\
				\rowcolor[HTML]{EFEFEF} 
				4 & 20 & 100 & 196 & 3034 & 0.9 $\pm$ 0.26 & 16.8 $\pm$ 3.57 & 7.4 $\pm$ 1.89 \\
				\rowcolor[HTML]{EFEFEF} 
				5 & 33 & 100 & 196 & 1355 & 2.1 $\pm$ 0.53 & 23.4 $\pm$ 5.87 & 10.7 $\pm$ 2.43 \\
				6 & 5 & 200 & 786 & 7824 & 0.1 $\pm$ 0.05 & 14.8 $\pm$ 1.66 & 4.6 $\pm$ 1.26 \\
				7 & 10 & 200 & 779 & 5631 & 0.3 $\pm$ 0.06 & 13.5 $\pm$ 2.42 & 4.9 $\pm$ 0.77 \\
				8 & 20 & 200 & 792 & 4445 & 0.9 $\pm$ 0.25 & 10.4 $\pm$ 0.98 & 7.6 $\pm$ 1.86 \\
	...
	\begin{appendices}
		...
		\index[terms]{greedy algorithm}\index[terms]{greedy algorithm!results}\index[terms]{constructive heuristic!greedy algorithm}
		...
		\begin{landscape}		\index[terms]{greedy algorithm}\index[terms]{greedy algorithm!results}\index[terms]{constructive heuristic!greedy algorithm}
		...
		The following table provides the results obtained from 50 runs of the fast greedy algorithm.  The first five columns provide information related to each of the forty test problems obtained from Beasley's library \cite{BEAS90} and was provided in the corresponding text file.The first five columns provide information related to each of the forty test problems obtained from Beasley's library \cite{BEAS90} and was provided in the corresponding text file.
		The next four columns relate the to recorded computational time in seconds.
		
		The final four columns relate to the difference between the objective function value of the final solutions and the known optimal solution's objective function.
		\begin{landscape}\index[terms]{fast greedy algorithm}\index[terms]{fast greedy algorithm!results}\index[terms]{constructive heuristic!fast greedy algorithm}
			\begin{longtable}[c]{ccccc|cccc|cccc}
		...
		\index[terms]{stingy algorithm}\index[terms]{stingy algorithm!results}\index[terms]{constructive heuristic!stingy algorithm}
		...
		\begin{landscape}\index[terms]{stingy algorithm}\index[terms]{stingy algorithm!results}\index[terms]{constructive heuristic!stingy algorithm}
			\begin{longtable}[c]{ccccc|cccc|cccc}
		...
		\index[terms]{interchange algorithm of Teitz and Bart}\index[terms]{interchange algorithm of Teitz and Bart!results}\index[terms]{local search heuristic!interchange algorithm of Teitz and Bart}
		...
		\begin{landscape}\index[terms]{interchange algorithm of Teitz and Bart}\index[terms]{interchange algorithm of Teitz and Bart!results}\index[terms]{local search heuristic!interchange algorithm of Teitz and Bart}
		...
		\index[terms]{fast interchange algorithm}\index[terms]{fast interchange algorithm!results}\index[terms]{local search heuristic!fast interchange algorithm}
		...
		\begin{landscape}\index[terms]{fast interchange algorithm}\index[terms]{fast interchange algorithm!results}\index[terms]{local search heuristic!fast interchange algorithm}
			\begin{longtable}[c]{ccccc|cccc|cccc|cccc}
		...
		\index[terms]fast {alternate algorithm}\index[terms]{alternate algorithm!results}\index[terms]{local search heuristic!alternate interchange algorithm}
		...
		\begin{landscape}\index[terms]fast {alternate algorithm}\index[terms]{alternate algorithm!results}\index[terms]{local search heuristic!alternate interchange algorithm}
			\begin{longtable}[c]{ccccc|cccc|cccc|cccc}
