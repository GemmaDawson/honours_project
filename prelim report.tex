...
\usepackage[linesnumbered,ruled]{algorithm2e} %pretty pseudocode
...
\begin{document}
	...
	The pseudocode \index[terms]{greedy algorithm! pseudocode} for this algorithm is given below:

	\begin{algorithm}[H]
		\KwData{Cost Matrix}
		\KwResult{\emph{P}* populated with the set of nodes designated as the solution medians}
