...
for (problem in 1:40){
  ...
  TB_Solution <-  vector(mode = "numeric", length=100)
  TB_Percent <- vector(mode = "numeric", length=100)
  TB_Time <- vector(mode = "numeric", length=100)
  ...
  # name=str_c("E:/Project/TB Interchange Solutions/TB", problem, ".rds", sep="")
